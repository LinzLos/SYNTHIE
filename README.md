...
- **Evidence ledger + invariants** — traceability, attribution integrity, attribute fidelity, quantifier↔count parity, stance fidelity (stated vs. conditional), outlier surfacing.
